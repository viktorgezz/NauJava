package ru.viktorgezz.testing_system.handler;
...
public class TestingSystemCoreExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(TestingSystemCoreExceptionHandler.class);
