...
class AuthUiTest extends AbstractUiTest {
    ...
    /**
     * <p>Тестирование успешной авторизации, проверка перенаправления на главную страницу
     * после входа и проверка выхода из системы.</p>
     * <br>
     * <b><ol>
     * <li>Подготовка:</li>
     * <ul>
     * <li>Переход на страницу авторизации.</li>
     * </ul>
     * <br>
     * <li>Действия:</li>
     * <ul>
     * <li>Ввод имени пользователя ("user") и пароля ("password") в соответствующие поля.</li>
     * <li>Нажатие на кнопку "Login" (Войти).</li>
     * <li>Нажатие на кнопку "Logout" (Выход).</li>
     * </ul>
     * <br>
     * <li>Проверки:</li>
     * <ul>
     * <li>Проверить, что после входа заголовок страницы равен "Tests".</li>
     * <li>Проверить, что текущий URL содержит "/ui/tests" (успешное перенаправление).</li>
     * <li>Проверить, что после выхода из системы заголовок страницы равен "Login".</li>
     * <li>Проверить, что форма авторизации отображается (успешный выход).</li>
     * </ul>
     * </ol></b>
     */
    @Test
